...
MapGroup_NewBark:
	...
	map SilentForest, TILESET_JOHTO, TOWN, ROUTE_26, MUSIC_UNUSED_SONG, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cherrygrove:
	...
	map SilentHills, TILESET_FOREST, ROUTE, ILEX_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND