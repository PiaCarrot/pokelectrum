...
RaichuEvosAttacks:
	dbbw EVOLVE_ITEM, MIST_STONE, GOROCHU
	db 0 ; no more evolutions
	db 1, THUNDERSHOCK
	db 1, TAIL_WHIP
	db 1, QUICK_ATTACK
...
DittoEvosAttacks:
	dbbw EVOLVE_TRADE, METAL_COAT, LYKWYSE
	dbbw EVOLVE_LEVEL, 28, LYKWYSE
	db 0 ; no more evolutions
	db 1, TRANSFORM
	db 0 ; no more level-up moves
...
SunmolaEvosAttacks:
	dbbw EVOLVE_LEVEL, 19, ANCHORAGE
	db 0 ; no more evolutions
	db 1, TACKLE
	db 3, GROWL
	db 6, WATER_GUN
