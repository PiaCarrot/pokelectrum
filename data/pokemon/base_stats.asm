...
_tms4 = 0 ; TM73-TM88 + HM01-HM07 (24)
rept _NARG
	if DEF(\1_TMNUM)
	if \1_TMNUM < 24 + 1
...
_tms3 = _tms3 >> 8
endr
rept 3 ; TM73-TM88 + HM01-HM07 (24/24)
	db _tms4 & $ff
_tms4 = _tms4 >> 8
endr
ENDM
...
INCLUDE "data/pokemon/base_stats/chiks.asm"
...
INCLUDE "data/pokemon/base_stats/bellarun.asm"
INCLUDE "data/pokemon/base_stats/minicorn.asm"
INCLUDE "data/pokemon/base_stats/turbann.asm"
INCLUDE "data/pokemon/base_stats/grimey.asm"
INCLUDE "data/pokemon/base_stats/puddi.asm"
